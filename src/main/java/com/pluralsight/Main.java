...
public class Main {
    ...
    public static void processListAllProducts(HashMap<Integer, Product> product) {
    ...
    public static void processLookupProductById(HashMap<Integer, Product> products) {
        int getProductId = Console.askForInt("What is the product ID?", 1000, 9999);
    ...
    public static HashMap<Integer, Product> processFindProductWithinPriceRange(HashMap<Integer, Product> product) {
    ...
    public static void addNewProduct(HashMap<Integer, Product> product) {
        int addNewProductId = Console.askForInt("What's the product id: ", 1, 9999);
        while(product.containsKey(addNewProductId)) {
            System.out.println("This product id already exist! Try again");
            addNewProductId = Console.askForInt("What's the product id: ", 1, 9999);
        }

        String addNewProductName = Console.askForString("What's the product name: ");
        double addNewProductPrice = Console.askForDouble("What's the price of this product: ");
    ...
    public static void writeToProductInventory(HashMap<Integer, Product> product) {
        try {
            ...
            for (Product p : product.values()) {
                String formattedLine = p.getProductId() + "|" +
                        p.getProductName() + "|" +
                        p.getProductPrice() + "\n";
